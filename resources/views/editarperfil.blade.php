...
<head>
  <link rel="stylesheet" href="{{ asset('estilos/editperfil.css') }}">
...
<body>
  ...
  <div class="contenedor">
    ...
    <form action="{{ route('perfil.update', $user->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <input onkeyup="removeSpaces(this)" id="ots" type="text" name="name" value="{{ $user->name }}">
      <label for="email">Email:</label>
      <input id="ots" type="email" name="email" value="{{ $user->email }}">
      <label for="email">Fecha de Nacimiento</label>
      <input type="date" id="fechaCumpleanos" oninput="calcularDiasRestantes()" name="birthay" value="{{ $user->birthay }}">
      ...
      <label for="email">Orientacion</label>
      <select name="orientacion" class="form-control">
        <option value="{{$user->orientacion}}">{{$user->orientacion}}</option>
  ...
  <script src="{{ asset('editperfil.js')}}"></script>
